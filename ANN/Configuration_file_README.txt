...
#   :param structure: for every hidden layer, insert value for number of nodes per hidden layer, separated by a space
...
#   -> for more realistic predictions, use a training dataset percentage of size x and testing dataset
#   size 1-x
